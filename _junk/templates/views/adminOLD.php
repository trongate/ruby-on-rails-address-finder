    ...
    <div class="navbar">
        <div class="navbar-inner">
            <div class="container-fluid">
                ...
                <a class="brand" href="index.html"><span>CI SHOP</span></a>
            ...
            <div id="sidebar-left" class="span2">
                <div class="nav-collapse sidebar-nav">
                    <ul class="nav nav-tabs nav-stacked main-menu">
                        ...
                        ?>
                        <li><a href="<?= BASE_URL ?>location/manage"><i class="icon-picture"></i><span class="hidden-tablet"> Manage Locations</span></a></li>
                        <li><a href="<?= BASE_URL ?>sliders/manage"><i class="icon-picture"></i><span class="hidden-tablet"> Manage Slider(s)</span></a></li>
